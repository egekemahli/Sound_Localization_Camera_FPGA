...
set_property PACKAGE_PIN V17 [get_ports {swit}]                    
    set_property IOSTANDARD LVCMOS33 [get_ports {swit}]
...
#set_property PACKAGE_PIN T3 [get_ports {Sin1}]					
#        set_property IOSTANDARD LVCMOS33 [get_ports {Sin1}]
#    set_property PACKAGE_PIN T2 [get_ports {Sin2}]                    
#        set_property IOSTANDARD LVCMOS33 [get_ports {Sin2}]
#    set_property PACKAGE_PIN R3 [get_ports {Sin3}]                    
#        set_property IOSTANDARD LVCMOS33 [get_ports {Sin3}]
